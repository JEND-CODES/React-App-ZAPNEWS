...
// Tuto youtube Map item from API : https://www.youtube.com/watch?v=_eFYzxpvUkc

// Voir les sources des données : https://newsapi.org/s/france-news-api


// Ajouté pour le Show or Hide a component :
/*
...
class ApiMapNews extends Component {
    constructor() {
        ...
        this.state = {
          ...
          // Testés pour concaténation dans les URLs fetch() :
          // infoSource: 'buzzfeed',
          // infoSource2: 'bbc-news',
          button: true,
          // childVisible: false,
        }
    ...
    */
      ...
      // Au lieu d'appeler immédiatement l'API, on peut utiliser un bouton pour activer l'appel
      // Voir démo Codepen : https://codepen.io/aamulumi/pen/NAymbW?editors=0010
    ...
    getData2() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=fr&category=sports&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData3() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=fr&category=business&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData4() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=fr&category=health&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData5() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=fr&category=science&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData6() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=fr&category=entertainment&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData7() {
        ...
        let data_first = fetch('http://newsapi.org/v2/top-headlines?country=fr&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
...
*/}
                ...
                <button className="button-effect btn-3 hide-first-datas" onClick={ refreshPage }> A la Une <i className="far fa-star"></i> </button>
                ...
                High Tech <i className="fas fa-desktop"></i>
                </button>
                                            ...
                                            <div className="grid">
                                                ...
                                                <figure className="effect-bubba">
                                                    ...
                                                    <figcaption>
                                                        ...
                                                        <p style={{ fontSize: '20px', background: 'white'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lire la suite</p>
